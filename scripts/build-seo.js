...
<body>
  ${bodyContent}
  <a href="https://api.whatsapp.com/send?phone=46701619978&text=Regarding%20an%20off-market%20M%26A%20mandate" target="_blank" rel="noopener noreferrer" class="wa-btn" onclick="setTimeout(() => { window.location.href = 'tel:+46701619978'; }, 2000);">
...
async function generateSEO() {
  ...
  console.log('Building Jonas Hyltén Site...');
  ...
  const indexBody = `
    <div class="container" style="max-width:900px; text-align:center;">
      ...
      <p class="index-sub">Briefings on off-market M&A, agentic origination workflows and acquisition execution for family offices and private capital principals.</p>
      ${searchBox}
      ${hasMultipleYears || hasCategories ? filterNav : ''}
      ${listItems}
    </div>`;

  const indexHtml = htmlBuilder('Intelligence', 'Briefings on off-market M&A, agentic origination workflows and acquisition execution for family offices and private capital principals.', indexBody);
